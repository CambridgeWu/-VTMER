...
<script type="text/javascript">
    function addCourse(teacher,coursename,classroom,time) {
        ...
        if (result) {
            window.location.href = "Courseservlet?param=add&teacher=" + teacher + "&coursename=" + coursename + "&classroom=" + classroom + "&time=" + time;
        }
    }
    function deleteCourse(teacher,coursename,classroom,time) {
        var result = window.confirm("确认删除吗？");
        if (result) {
            window.location.href = "Courseservlet?param=delete&teacher=" + teacher + "&coursename=" + coursename + "&classroom=" + classroom + "&time=" + time;
        }
    }
    function modify(teacher,coursename,classroom,time) {
        window.location.href="ModifyCourse.jsp?teacher=" + teacher + "&coursename=" + coursename + "&classroom=" + classroom + "&time=" + time;
    }
</script>
<body>
<%
    ...
    List<Course> courseList=teacherService.FindAllCourse();
%>
<h1 align="center">VTMER课程系统</h1>
<h2 align="center">课程管理</h2>
<hr />
